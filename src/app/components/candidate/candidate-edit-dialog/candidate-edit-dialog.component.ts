...
import { AddCandidateToVacancyDialogComponent } from '../add-candidate-to-vacancy-dialog/add-candidate-to-vacancy-dialog.component';
import { EditCandidateToVacancyDialogComponent } from '../edit-candidate-to-vacancy-dialog/edit-candidate-to-vacancy-dialog.component';
...
@Component({
  ...
  styleUrl: './candidate-edit-dialog.component.scss',
  providers: [DataAccessService, RouterService]

})

export class CandidateEditDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(private route: ActivatedRoute, public dialogRef: MatDialogRef<CandidateEditDialogComponent>, private dataAccess: DataAccessService, private router: RouterService, private dialog: MatDialog, private titleService: Title) { }
        ...
        if (this.url_id==null ||  this.url_id == 0) {
          ...
          if (data.candidateId) {
            ...
            if (this.linkedin_url && this.linkedin_url != "") {
              ...
              this.router.goToVacancyCandidateListFromStateList(this.selectedVacancyId, 0, this.form_data.id);
